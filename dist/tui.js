...
var AGENT_CONFIG_FILE = path.join(os.homedir(), ".config", "opencode", "oh-my-opencode-cohub.json");
...
var STATE_FILE = path.join(os.homedir(), ".local", "share", "opencode", "storage", "oh-my-opencode-cohub", "tracker-state.json");
var SPINNER_FRAMES = ["⠋", "⠙", "⠹", "⠸", "⠼", "⠴", "⠦", "⠧", "⠇", "⠏"];
function readState() {
  try {
        ...
        sidebar_content() {
          ...
          return jsx("box", {
            ...
            children: [
              ...
              jsx("box", { height: 1 }),
              runningCount > 0 ? jsx("text", { fg: theme.accent, children: `${spinner} ${runningCount} 任务运行中` }) : jsx("text", { fg: theme.success, children: "✓ 已激活 · 纯调度模式" })
            ]
          });
        }
      }
